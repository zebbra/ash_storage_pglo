defmodule AshStoragePGLO.Test.Repo.Migrations.InitialMigrationExtensions1 do
  @moduledoc """
  ...
  def up do
    ...
    execute("CREATE EXTENSION IF NOT EXISTS \"lo\"")
  end
  ...
  def down do
    ...
    # execute("DROP EXTENSION IF EXISTS \"lo\"")
  end
end
